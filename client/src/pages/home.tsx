      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mt-8 md:mt-10 flex flex-col items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1 md:gap-2 text-[9px] md:text-xs tracking-[0.15em] md:tracking-[0.25em] uppercase text-white/15 md:text-white/25 hover:text-gold/40 transition-all duration-500 group whitespace-nowrap"
            data-testid="link-creator-credit"
          >
            <span>Designed by</span>
            <span className="text-gold/30 md:text-gold/50 group-hover:text-gold transition-colors duration-500">Aman Gupta</span>
            <Instagram className="w-2.5 h-2.5 md:w-3 md:h-3 text-gold/25 md:text-gold/40 group-hover:text-gold transition-colors duration-500" />
            <span className="text-gold/25 md:text-gold/40 group-hover:text-gold transition-colors duration-500">@amangupta.yt</span>
          </a>
        </div>
      </div>
    </footer>
  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-black/80 backdrop-blur-2xl border border-gold/20 shadow-[0_8px_40px_rgba(0,0,0,0.6),0_0_0_1px_rgba(212,175,55,0.08)]">
            <a
              href={`tel:${PHONE_NUMBER}`}
              data-testid="button-dock-call"
              className="flex flex-col items-center gap-0.5 px-3.5 py-1.5 rounded-full bg-gold/10 border border-gold/30 transition-all duration-300 hover:bg-gold hover:border-gold group"
              aria-label="Call us"
            >
              <Phone className="w-4 h-4 text-gold group-hover:text-charcoal transition-colors duration-300" />
              <span className="text-[8px] tracking-widest uppercase text-gold/70 group-hover:text-charcoal transition-colors duration-300">Call</span>
            </a>
            ...
            >
              <MapPin className="w-4 h-4 text-gold group-hover:text-charcoal transition-colors duration-300" />
              <span className="text-[8px] tracking-widest uppercase text-gold/70 group-hover:text-charcoal transition-colors duration-300">Location</span>
            </a>
            ...
            >
              <svg viewBox="0 0 24 24" className="w-4 h-4 fill-gold group-hover:fill-charcoal transition-colors duration-300" xmlns="http://www.w3.org/2000/svg">
              ...
              <span className="text-[8px] tracking-widest uppercase text-gold/70 group-hover:text-charcoal transition-colors duration-300">WhatsApp</span>
            </a>
          </div>
        </motion.div>
      )}
