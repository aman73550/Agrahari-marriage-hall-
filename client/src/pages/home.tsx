  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="bg-[#111]/95 backdrop-blur-2xl border-t border-gold/15 shadow-[0_-8px_30px_rgba(0,0,0,0.6)]">
            <div className="flex items-stretch justify-around max-w-md mx-auto">
              <a
                href={`tel:${PHONE_NUMBER}`}
                data-testid="button-dock-call"
                className="flex flex-col items-center justify-center gap-1 py-3 px-6 transition-colors duration-300 active:bg-gold/10"
                aria-label="Call us"
              >
                <Phone className="w-5 h-5 text-gold" />
                <span className="text-[10px] tracking-[0.12em] uppercase text-white/50">Call</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] tracking-[0.12em] uppercase text-white/50">Directions</span>
              </a>
              ...
              >
                ...
                <span className="text-[10px] tracking-[0.12em] uppercase text-white/50">WhatsApp</span>
              </a>
            </div>
          </div>
        </motion.div>
...
export default function Home() {
  ...
  return (
    <motion.div
      ...
      className="bg-[#0a0a0a] min-h-screen overflow-x-hidden pb-20 md:pb-0"
    >
      <Navbar />
      <HeroSection />
      <AboutSection />
